#
# BoardConfig.mk - Functional for TWRP 14.1
#
...
# CRITICAL FIX: Defines the TWRP UI library to prevent the 'Killed' memory error
TARGET_RECOVERY_UI_LIB := twrp_gui
...
BOARD_DTBOIMG_PARTITION_SIZE := 2105344
...
# Verified Boot / AVB disabled for TWRP
